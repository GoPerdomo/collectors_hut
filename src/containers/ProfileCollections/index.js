...
class ProfileCollections extends Component {
  ...
  //   fetch(`http://localhost:3030/api/users/5a1da1bf972c7b073ae06e17/collections/${collectionId}`, httpHeaders)
  //     .then(res => res.json())
  ...
  render() {
    return (
      <section className="collection">
        ...
        {
          this.props.user.collections.items && this.props.user.collections.items.map(item => <img key={ item._id } src={ item.photo } alt="TODO: Add a nonredundant alt"/>)
        }
        </div>
